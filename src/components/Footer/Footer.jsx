    ...
    <>
      <div className="py-10 relative overflow-hidden">
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 py-5 bg-white/80 backdrop-blur-sm rounded-t-xl">
            <div className="py-8 px-4">
              <h1 className="flex items-center justify-center gap-3 text-xl md:text-3xl font-bold  text-left md:text-justify ">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 col-span-2 md:pl-10">
              <div>
                <div className="py-8 px-4">
                  <h1 className="text-xl font-bold text-left md:text-justify  mb-3">
                    Important Links
                  </h1>
          ...
          <div>
            <div className="text-center p-4  border-gray-300/50  bg-primary ">
